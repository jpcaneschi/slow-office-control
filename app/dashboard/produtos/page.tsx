    ...
    <section className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
        <div className="rounded-[28px] border border-white/10 bg-[#0f141b] p-5">
          <p className="text-sm font-bold text-zinc-300">Total de produtos</p>
        ...
        <div className="rounded-[28px] border border-[#7da2ff]/20 bg-[#7da2ff]/[0.06] p-5">
          <p className="text-sm font-bold text-[#9bb7ff]">Produtos ativos</p>
          <p className="mt-3 text-3xl font-black tracking-tight text-white">
            {resumo.ativos}
          </p>
        </div>
        ...
        <div className="rounded-[28px] border border-[#d4a93a]/20 bg-[#d4a93a]/[0.06] p-5">
          <p className="text-sm font-bold text-[#f3d37a]">Estoque baixo</p>
          <p className="mt-3 text-3xl font-black tracking-tight text-white">
            {resumo.estoqueBaixo}
          </p>
        </div>
        ...
        <div className="rounded-[28px] border border-red-500/20 bg-red-500/[0.06] p-5">
          <p className="text-sm font-bold text-red-300">Estoque zerado</p>
          <p className="mt-3 text-3xl font-black tracking-tight text-white">
        ...
        <div className="rounded-[28px] border border-emerald-500/20 bg-emerald-500/[0.06] p-5">
          <p className="text-sm font-bold text-emerald-300">Estoque total</p>
          <p className="mt-3 text-3xl font-black tracking-tight text-white">
            {resumo.estoqueTotal}
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="rounded-[30px] border border-white/10 bg-white/[0.03] p-6">
            <div className="flex items-center justify-between gap-3">
              ...
              {editandoId && (
                <button
                  ...
                  className="rounded-2xl border border-white/10 bg-[#0f141b] px-3 py-2 text-xs font-bold text-white transition hover:bg-[#151b24]"
                >
                  Cancelar
                </button>
              )}
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-4">
              ...
              <div>
                <label className="mb-2 block text-sm text-zinc-300">Custo</label>
                <input
                  type="number"
                  step="0.01"
                  value={custo}
          ...
          <div className="rounded-[30px] border border-white/10 bg-white/[0.03] p-6">
            ...
            <form onSubmit={handleMovimentacao} className="mt-5 space-y-4">
              ...
              <button
                ...
                className="w-full rounded-2xl border border-[#d4a93a]/20 bg-[#d4a93a]/10 px-4 py-3 font-bold text-[#f3d37a] transition hover:bg-[#d4a93a]/20 disabled:opacity-60"
              >
        ...
        <div className="space-y-6">
          <div className="rounded-[30px] border border-yellow-500/20 bg-yellow-500/[0.06] p-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-[11px] font-extrabold uppercase tracking-[0.28em] text-yellow-300">
                  Atenção operacional
                </p>
              ...
              <div className="rounded-2xl border border-yellow-500/20 bg-[#0b0f14] px-4 py-3 text-center">
            ...
            <div className="mt-5 space-y-3">
              {produtosCriticos.length === 0 ? (
                <div className="rounded-[22px] border border-emerald-500/20 bg-emerald-500/[0.06] p-4 text-sm text-emerald-300">
                    ...
                    >
                      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                        <div>
                          ...
                          <p className="mt-2 inline-flex rounded-full bg-[#d4a93a]/10 px-3 py-1 text-xs font-bold text-[#f3d37a]">
